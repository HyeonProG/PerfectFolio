...
public class Define {
	...
	public static final Integer QUALIFICATION_ID = 1;
	public static final Integer LINGUISTIC_ID = 2;

	// 포트폴리오 상태
	public static final String STATUS_APPROVAL = "승인";
	public static final String STATUS_WAIT = "대기";
	public static final String STATUS_COMPANION = "반려";
	
	// 유저의 입사제안서 상태
	public static final String STATUS_USER_ACCEPT = "수락";
	public static final String STATUS_USER_WAIT = "대기";
	public static final String STATUS_USER_REFUSAL = "거절";
}
