...
<div class="contents--wrap">
	<form id="searchForm" class="d-flex align-items-center">
		<div class="form-group p-2">
			<select name="searchType" id="searchType" class="form-control">
				<option value="" disabled selected>검색 유형 선택하기</option>
	...
	<div id="userListContainer" class="list--container">
		<h2>사용자 목록</h2>
		<table class="table">
			<thead>
				<tr>
	...
	<div class="select--btn">
		<a href="/admin/withdrawPage" class="btn btn-primary">탈퇴회원 조회</a>
	</div>
...
<script>
		document.getElementById('searchForm').addEventListener('submit', function(event) {
			...
			fetchPage(1, 10, searchType, keyword);
		...
		function fetchPage(page, size, searchType ='', keyword='') {
			...
			// 전체 리스트 조회 URL
			let fetchUrl = `http:perfecfolio.jinnymo.com/admin/userList?page=` + page + `&size=` + size;
			...
			if(keyword) {
             ...
             .then(data => {
                 renderUserList(data.userList); // 공지사항 목록 렌더링
	    ...
	    function renderUserList(userList) {
	        ...
	        userList.forEach(user => {
	            ...
	            tr.addEventListener('click', () => {
	                window.location.href = "/admin/detailUserInfo?id=" + user.id;
	            });
	            ...
	            tr.appendChild(userEmailCell);
	            
	            const userNicknameCell = document.createElement('td');
	            userNicknameCell.textContent = user.userNickname;
	            tr.appendChild(userNicknameCell);
	            ...
	            const orderDaysCell = document.createElement('td');
	            orderDaysCell.textContent = user.orderDays;
	            tr.appendChild(orderDaysCell);
