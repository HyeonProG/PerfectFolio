...
<body class="body--bg">
		...
		<header class="header">
			<h1 class="main--logo">
				<a href="/user/main"> <img
					src="/images/main/PerfectFolio_logo_white.gif" alt="">
				</a>
			</h1>
							...
							<c:choose>
								...
								<c:when test="${principal != null}">
									<li class="util--sub--item"><a href="/user/my-info"
										class="sub--link">마이페이지</a></li>
									<li class="util--sub--item"><a href="/user/recommendListPage"
										class="sub--link">기업 매칭률</a></li>
									<li class="util--sub--item"><a href="/user/logout"
										class="sub--link">로그아웃</a></li>
								</c:when>
	...
	<script>
		function openChatBot() {
			window.open('http://perfecfolio.jinnymo.com/chat/chatPage', 'chatBotPopup',
